...
import { sendToQueue } from '../utils/amqp.js';
import { createLogger } from '../utils/logger.js';
import type { AccountsResult, BetsData, PlayerDetails, WebhookData, WebhookKey } from "../interfaces/appInterfaces.js"
...
//             ...baseData,
//             amount: amountFormatted,
//             description: `${Number(bet_amount).toFixed(2)} debited for Red Or Black Mini game for Round ${id}`,
//             bet_id,
//             txn_type: 0
//         }
...
//             txn_ref_id: txn_id,
//             description: `${winning_amount} credited for VideoPoker ${id}`,
//             txn_type: 1
//         }
//         else return baseData;
//     } catch (err) {
...
export const sendRequestToAccounts = async (webhookData: WebhookData, token: string): Promise<Boolean> => {
    try {
        ...
        console.log(data, " Posting to the service url that DEBIT amount ")
