...
const jsonlStream = (filePath: string): WriteStream => fs.createWriteStream(filePath , { flags: 'a' });

export const createLogger = (moduleName: string, format: 'plain' | 'jsonl' = 'plain'): Logger => {
    const logDir = 'logs';
